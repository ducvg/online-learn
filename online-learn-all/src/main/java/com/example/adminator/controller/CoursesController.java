...
public class CoursesController {
    ...
    public String getLessonByCourseID(Model model, @RequestParam("CourseID") Integer CourseID){
        List<Object[]> lessons = lessonService.getLessonByCourseID(CourseID);
        List<Object[]> randomLessons = getRandomLessons(lessons, 3);
        model.addAttribute("lessons",lessons);
        model.addAttribute("random",randomLessons);
        return "materi";
    }

    private List<Object[]> getRandomLessons(List<Object[]> lessons, int count) {
